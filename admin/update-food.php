    ...
    <div class="wrapper">
        ...
        <table class="tbl-30">
            ...
            <tr>
                <td>Trending Dish: </td>
                <td>
                    <input <?php if($trending=="Yes") {echo "checked";} ?> type="radio" name="trending" value="Yes"> Yes 
                    <input <?php if($trending=="No") {echo "checked";} ?> type="radio" name="trending" value="No"> No 
                </td>
            </tr>
            <tr>
                <td>Featured: </td>
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        $image_name = "Food-Menu-".rand(0000, 9999).'.'.$ext; //Renamed image
                ...
                if($res3==true)
                {
                    //Query Exectued and Food Menu  Updated
