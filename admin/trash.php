        ...
        <?php 
            ...
            if(isset($_POST['submit']))
            {
                ...
                else
                {
                 ...
                 //Check whether radio button for special dish, Popular food and Trending are checked or not
                ...
                {
                    $popular = "No"; //Setting Default Value
                }
                ...
                {
                    $trending = "No"; //Setting Default Value
                }
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        $image_name = "Food-Menu-".rand(0000,9999).".".$tmpr; //New Image Name May Be "Food-Menu-657.jpg"
                ...
                //4. Redirect with MEssage to Manage Food Menu
                if($res2 == true)
                {
